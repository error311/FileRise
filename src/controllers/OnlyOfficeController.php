...
require_once __DIR__ . '/../FileRise/Http/Controllers/OnlyOfficeController.php';
...
$original = '\\FileRise\\Http\\Controllers\\OnlyOfficeController';
$alias = 'OnlyOfficeController';
